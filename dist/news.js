...
/***/ "./Html_Templates/News_Single_News_Html.js":
/*!*************************************************!*\
  !*** ./Html_Templates/News_Single_News_Html.js ***!
  \*************************************************/
...
/* harmony export */   news_single_news_html: () => (/* binding */ news_single_news_html)
/* harmony export */ });
const news_single_news_html = `

<div class="posts__PostListItem-sc-yqhhz3-1 eSXAug news_container">
                  <div class="sc-kgAjT ixrNzp card_wrapper">
                    <div class="sc-cJSrbW dLwzxs header_wrapper">
                      <div class="sc-frDJqD ceDRQe img_wrapper">
                        <a class="sc-htpNat bUhGXt link sc-uJMKN eYExmJ single_news styled_link" href="" aria-label="An indexing update from BioMed Research International  "><img class="sc-csuQGl jwRblM" src="XXXNEWS_IMAGE_SRC_SMALL_XXX" alt="XXXNEWS_IMAGE_ALT_SMALL_XXX" width="100%" height="auto" style="/* display: none; */"></a>
                      </div>
                      <div class="sc-kvZOFW dlNHCW card_header">
                        <a class="sc-htpNat bUhGXt link sc-uJMKN eYExmJ single_news styled_link" href="" aria-label="XXXNEWS_TITLEV_SMALL_XXX"><h3 title="XXXNEWS_TITLEV_SMALL_XXX" class="sc-ksYbfQ bWbAkS styled_title">
                            XXXNEWS_TITLEV_SMALL_XXX
                          </h3></a>
                      </div>
                    </div>
                    <p class="sc-hqyNC hKvKBK card_body line-clamp-3">
                      XXXNEWS_ABSTRACT_SMALL_XXX
                    </p>
...
/*!*********************!*\
  ...
  \*********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Html_Templates_News_Single_News_Html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Html_Templates/News_Single_News_Html */ "./Html_Templates/News_Single_News_Html.js");
/* harmony import */ var _Utils_Mock_Data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Utils/Mock_Data */ "./Utils/Mock_Data.js");
/* harmony import */ var _Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Utils/Selectors_And_PlaceHolders */ "./Utils/Selectors_And_PlaceHolders.js");
...
const populate_page = () => {
  const news_html_template = _Html_Templates_News_Single_News_Html__WEBPACK_IMPORTED_MODULE_0__.news_single_news_html;
  const news_html_filled = _Utils_Mock_Data__WEBPACK_IMPORTED_MODULE_1__.News.map((el) => {
    let temp_news_html = (0,_Utils_General_Utils__WEBPACK_IMPORTED_MODULE_3__.applyPlaceholder)(
      news_html_template,
      _Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Placeholders.News.single_news.news_abstract,
      el.news_abstract
    );
    temp_news_html = (0,_Utils_General_Utils__WEBPACK_IMPORTED_MODULE_3__.applyPlaceholder)(
      temp_news_html,
      _Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Placeholders.News.single_news.news_authors,
      "NLA Enugu State Chapter"
    );
    temp_news_html = (0,_Utils_General_Utils__WEBPACK_IMPORTED_MODULE_3__.applyPlaceholder)(
      temp_news_html,
      _Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Placeholders.News.single_news.news_title,
      el.news_title
    );
    temp_news_html = (0,_Utils_General_Utils__WEBPACK_IMPORTED_MODULE_3__.applyPlaceholder)(
      temp_news_html,
      _Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Placeholders.News.single_news.news_publish_date,
      el.news_publish_date
    );
    temp_news_html = (0,_Utils_General_Utils__WEBPACK_IMPORTED_MODULE_3__.applyPlaceholder)(
      temp_news_html,
      _Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Placeholders.News.single_news.news_image_src,
      `${_Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Routes.NewsImages}${el.news_image_src}`
    );

    return temp_news_html;
  }).join(" ");
  (0,_Utils_General_Utils__WEBPACK_IMPORTED_MODULE_3__.insertInnerHtml)(_Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Selectors.News.news_container, news_html_filled);
};

(0,_Utils_General_Utils__WEBPACK_IMPORTED_MODULE_3__.selectElement)(_Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Selectors.News.NLA_Enugu_State_Chapter_bread_crumbs_Button).href =
  _Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Routes.Homepage;

populate_page();
const news = (0,_Utils_General_Utils__WEBPACK_IMPORTED_MODULE_3__.selectElements)(_Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Selectors.News.single_news);
for (let i = 0; i < news.length; i++) {
  news[i].href = _Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Routes.Single_News;
}
